...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "analytical/test/integration/FirstJourney",
    "analytical/test/integration/TicketAnalyticsListJourney",
    "analytical/test/integration/TicketAnalyticsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
